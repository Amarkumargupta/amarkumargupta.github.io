...
export default function BlogNotFound() {
  return (
    <div className="min-h-screen text-[rgb(var(--terminal-green))] p-4 flex flex-col items-center justify-center relative">
      ...
      <div className="max-w-md text-center relative z-10">
        ...
        <div className="terminal-text mb-6 bg-[rgba(10,10,10,0.7)] p-4 rounded border border-[rgba(var(--terminal-green),0.3)]">
          <p className="mb-2">$ find /blog/{'{slug}'}</p>
          <p className="text-[rgb(var(--terminal-red))]">Error: No such file or directory</p>
          <p className="mt-2">$ echo "The blog post you're looking for doesn't exist."</p>
        </div>
        <p className="mb-8">The requested blog post could not be found. It may have been moved or deleted.</p>
        <Link 
          href="/blog"
