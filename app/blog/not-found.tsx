...
export default function BlogNotFound() {
  return (
    <div className="min-h-screen bg-[rgb(var(--terminal-black))] text-[rgb(var(--terminal-green))] p-4 flex flex-col items-center justify-center relative overflow-hidden">
      {/* Keywords Background Animation */}
      <SimpleKeywordsBackground />
      
      <div className="max-w-md text-center relative z-10">
        <h1 className="text-4xl font-bold mb-4">404 - Blog Section Not Found</h1>
        <div className="terminal-text mb-6 bg-[rgba(10,10,10,0.7)] p-4 rounded border border-[rgba(var(--terminal-green),0.3)]">
          <p className="mb-2">$ find /blog</p>
          <p className="text-[rgb(var(--terminal-red))]">Error: Resource not found</p>
          <p className="mt-2">$ echo "The blog section you're looking for doesn't exist."</p>
        </div>
        <p className="mb-8">The requested blog section could not be found. It may have been moved or deleted.</p>
        <Link 
          href="/blog"
